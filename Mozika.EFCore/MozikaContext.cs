...
using Mozika.EFCore.Configurations;
using Mozika.Domain.Entities;

namespace Mozika.EFCore
{
    public class MozikaContext : DbContext
    {
        ...
        public MozikaContext(DbContextOptions options) : base(options) 
